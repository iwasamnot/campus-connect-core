  ...
  return (
    <div className="flex flex-col h-screen bg-transparent">
      ...
      <motion.div 
        ...
        className="glass-panel border-b border-white/10 backdrop-blur-xl px-4 sm:px-6 py-3 sm:py-4"
        style={{
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white text-glow">Users Management</h2>
      ...
      >
        ...
        <input
          ...
          className="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-white/10 rounded-xl glass-panel bg-white/5 backdrop-blur-sm text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 focus:bg-white/10 transition-all duration-300 hover:border-white/20 [color-scheme:dark]"
        />
      </motion.div>
        ...
        {filteredUsers.length === 0 ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <User className="mx-auto text-white/40 mb-4" size={48} />
          ...
          <div className="glass-panel border border-white/10 rounded-[2rem] shadow-xl overflow-hidden backdrop-blur-xl">
            ...
            <div className="hidden lg:block overflow-x-auto smooth-scroll overscroll-contain touch-pan-x">
              ...
              <thead className="glass-panel bg-white/5 backdrop-blur-sm sticky top-0 z-10">
                <tr>
                  ...
                  <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/70 uppercase tracking-wider hidden lg:table-cell">
                    Student Email
                  </th>
                  <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/70 uppercase tracking-wider hidden xl:table-cell">
                    Personal Email
                  </th>
                  <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/70 uppercase tracking-wider hidden xl:table-cell">
                    Phone
                  ...
                  <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-white/70 uppercase tracking-wider sticky right-0 glass-panel bg-white/5 backdrop-blur-sm">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="glass-panel bg-white/5 backdrop-blur-sm divide-y divide-white/10">
                {filteredUsers.map((user) => (
                  ...
                  >
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-mono text-white/60 hidden md:table-cell">
                      {user.id.substring(0, 8)}...
                    </td>
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                      <span className={`px-2 py-1 text-xs font-semibold rounded-full glass-panel ${
                    ...
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-white">
                      <div className="flex items-center gap-1 max-w-[200px] sm:max-w-none truncate">
                        <Mail size={12} className="text-white/50 flex-shrink-0" />
                        <span className="truncate">{user.email || 'N/A'}</span>
                      </div>
                    </td>
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-white hidden lg:table-cell">
                      {user.studentEmail ? (
                    ...
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-white hidden xl:table-cell">
                      {user.personalEmail ? (
                        <div className="flex items-center gap-1 max-w-[200px] truncate">
                          <Mail size={12} className="text-white/50 flex-shrink-0" />
                    ...
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-white hidden xl:table-cell">
                      {user.phoneNumber ? (
                        <div className="flex items-center gap-1">
                          <Phone size={12} className="text-white/50 flex-shrink-0" />
                          {user.phoneNumber}
                        </div>
                      ) : (
                        <span className="text-white/40">-</span>
                    ...
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-white/60 hidden md:table-cell">
                      <div className="flex items-center gap-1">
                        <Calendar size={12} className="text-white/40 flex-shrink-0" />
                    ...
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm">
                      <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
                        {user.role === 'admin' ? (
                          <span className="flex items-center gap-1 px-1.5 sm:px-2 py-1 text-xs font-semibold rounded-full glass-panel bg-green-600/20 border border-green-500/30 text-green-300">
                            <Shield size={10} className="sm:w-3 sm:h-3" />
                            <span className="hidden sm:inline">Auto</span>
                          </span>
                        ) : (
                          <>
                            <span className={`flex items-center gap-1 px-1.5 sm:px-2 py-1 text-xs font-semibold rounded-full glass-panel ${
                              user.emailVerified
                            ...
                            <motion.button
                              ...
                              whileTap={{ scale: 0.95 }}
                              className={`flex items-center gap-1 px-1.5 sm:px-2 py-1 text-xs rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                                user.emailVerified
                    ...
                    <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm sticky right-0 glass-panel bg-white/5 backdrop-blur-sm z-10">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <motion.button
                          ...
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                          className="flex items-center justify-center gap-1 px-2 sm:px-3 py-1.5 sm:py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed text-xs min-w-[60px] sm:min-w-auto"
                        ...
                        <motion.button
                          ...
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                          className="flex items-center justify-center gap-1 px-2 sm:px-3 py-1.5 sm:py-1 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed text-xs min-w-[60px] sm:min-w-auto"
                          title={
            ...
            <div className="lg:hidden space-y-3 p-4">
              {filteredUsers.map((user) => (
                <motion.div 
                  ...
                  className="glass-panel bg-white/5 border border-white/10 rounded-xl p-4 backdrop-blur-sm"
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {user.role === 'admin' ? (
                          <span className="flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded-full glass-panel bg-green-600/20 border border-green-500/30 text-green-300">
                            <Shield size={12} />
                            Auto Verified
                          </span>
                        ) : (
                          <span className={`flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded-full glass-panel ${
                            user.emailVerified
                              ? 'bg-green-600/20 border border-green-500/30 text-green-300'
                              : 'bg-red-600/20 border border-red-500/30 text-red-300'
                          }`}>
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-3 pt-3 border-t border-white/10">
                    {user.role !== 'admin' && (
                      <motion.button
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className={`flex items-center gap-1 px-3 py-1.5 text-xs rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex-1 min-w-[100px] justify-center ${
                          user.emailVerified
                            ? 'bg-yellow-600 hover:bg-yellow-700 text-white'
                            : 'bg-green-600 hover:bg-green-700 text-white'
                        }`}
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center gap-1 px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed text-xs flex-1 min-w-[100px] justify-center"
                    >
                      <Edit2 size={14} />
                      Edit
                    </motion.button>
                    <motion.button
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center gap-1 px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed text-xs flex-1 min-w-[100px] justify-center"
                    >
                      <Trash2 size={14} />
                      Delete
                    </motion.button>
      ...
      <motion.div 
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        className="glass-panel bg-indigo-600/20 border-t border-indigo-500/30 backdrop-blur-xl px-4 sm:px-6 py-2 sm:py-3"
      >
      ...
      {showEditModal && editing && (
        ...
        >
          <motion.div 
            ...
            className="glass-panel border border-white/10 rounded-[2rem] shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto backdrop-blur-xl"
          >
            <div className="sticky top-0 glass-panel border-b border-white/10 backdrop-blur-xl px-6 py-4 flex items-center justify-between rounded-t-[2rem]">
              <h3 className="text-xl font-bold text-white text-glow">Edit User Profile</h3>
              <motion.button
                onClick={handleCancelEdit}
                whileHover={{ scale: 1.1, rotate: 90 }}
                whileTap={{ scale: 0.95 }}
                className="text-white/70 hover:text-white transition-colors p-2 glass-panel border border-white/10 rounded-xl hover:border-white/20"
              >
                <X size={24} />
              </motion.button>
            </div>
            <div className="p-6 space-y-4">
              {/* Name */}
              <div>
                <label htmlFor="edit-user-name" className="block text-sm font-medium text-white/70 mb-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-white/10 rounded-xl glass-panel bg-white/5 backdrop-blur-sm text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 focus:bg-white/10 transition-all duration-300 hover:border-white/20 disabled:opacity-50 disabled:cursor-not-allowed [color-scheme:dark]"
              ...
              {/* Role */}
              <div>
                <label htmlFor="edit-user-role" className="block text-sm font-medium text-white/70 mb-2">
                  Role
                </label>
                <select
                  id="edit-user-role"
                  ...
                  className="w-full px-4 py-2 border border-white/10 rounded-xl glass-panel bg-white/5 backdrop-blur-sm text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all duration-300 hover:border-white/20 disabled:opacity-50 disabled:cursor-not-allowed [color-scheme:dark]"
                  disabled={saving === editing}
                >
              ...
              {/* Student Email */}
              <div>
                <label htmlFor="edit-user-student-email" className="block text-sm font-medium text-white/70 mb-2">
              ...
              {/* Personal Email */}
              <div>
                <label htmlFor="edit-user-personal-email" className="block text-sm font-medium text-white/70 mb-2">
                  <Mail className="inline mr-2" size={16} />
                  Personal Email
                </label>
                <input
              ...
              {/* Phone Number */}
              <div>
                <label htmlFor="edit-user-phone" className="block text-sm font-medium text-white/70 mb-2">
              ...
              {/* Profile Picture */}
              <div>
                <label htmlFor="edit-user-picture-url" className="block text-sm font-medium text-white/70 mb-2">
                ...
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <div className="flex-1">
                    <label htmlFor="edit-user-picture-upload" className="flex items-center justify-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl cursor-pointer transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed">
                      <Upload size={18} />
              ...
              {/* Bio */}
              <div>
                <label htmlFor="edit-user-bio" className="block text-sm font-medium text-white/70 mb-2">
              ...
              {/* Course */}
              <div>
                <label htmlFor="edit-user-course" className="block text-sm font-medium text-white/70 mb-2">
              ...
              {/* Year of Study */}
              <div>
                <label htmlFor="edit-user-year-of-study" className="block text-sm font-medium text-white/70 mb-2">
                  <GraduationCap className="inline mr-2" size={16} />
                  Year of Study
                </label>
                <select
              ...
              {/* Date of Birth */}
              <div>
                <label htmlFor="edit-user-date-of-birth" className="block text-sm font-medium text-white/70 mb-2">
              ...
              {/* Address */}
              <div>
                <label htmlFor="edit-user-address" className="block text-sm font-medium text-white/70 mb-2">
              ...
              <div className="flex gap-3 pt-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex-1 flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-xl transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Check size={20} />
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center gap-2 px-6 py-3 glass-panel border border-white/10 text-white/70 hover:text-white font-semibold rounded-xl hover:bg-white/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <X size={20} />
                  <span>Cancel</span>
                </motion.button>
